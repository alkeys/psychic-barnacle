...
interface EditarTecnicoProps {
	tecnico: Tecnico;
	onCancelar: () => void;
	onGuardar: (tecnicoActualizado: Tecnico) => void;
}
		...
		<div className="space-y-4">
			...
			<div className="flex justify-end space-x-3 pt-2">
				<button
					type="button"
					onClick={onCancelar}
					className="py-2 px-4 bg-gray-300 text-gray-800 font-medium rounded-lg shadow-md hover:bg-gray-400 transition duration-150"
					disabled={isSaving}
				>
					Cancelar
				</button>
