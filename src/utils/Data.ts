...
export const UserData = (data: UsuarioGetLogin, nombreUsuario: string): UsuarioLoginContext => {
    return {
        ...
        nombre_completo: data.tecnico?.nombreCompleto || data.cliente?.nombreCompleto || "",
